...
function HintPage() {
    ...
    return (
        <div style={{ width : '100%', margin: '3rem auto', backgroundColor: 'black'}}>
        
               <h1 style={{textAlign:'center',fontFamily:`'Times New Roman', Times, serif`,marginBottom: '30px',color:'white'}}>공략법/힌트</h1>
