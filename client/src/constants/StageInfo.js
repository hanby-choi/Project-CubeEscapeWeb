...
const stageInfo=[
    {stageId:1,stageName:'The Cube',stageText:'정신을 차려보니 알 수 없는 큐브공간 속에 갇혀있었다. 나는 누구이고 나를 여기에 가둔 관리인C 의 정체는 무엇인가. ',hint:{question :['Q1','Q2','Q3'] ,answer:["hint1","hint2","hint3"]},
